...
get_filename_component(_qt5QuickTemplates2_install_prefix "${QT_QMAKE_EXECUTABLE}" DIRECTORY)
get_filename_component(_qt5QuickTemplates2_install_prefix "${_qt5QuickTemplates2_install_prefix}/.." ABSOLUTE)

# For backwards compatibility only. Use Qt5QuickTemplates2_VERSION instead.
set(Qt5QuickTemplates2_VERSION_STRING 5.12.0)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_INCLUDE_DIRS )

    set(Qt5QuickTemplates2_DEFINITIONS -DQT_QUICKCONTROLS2_LIB)
    set(Qt5QuickTemplates2_COMPILE_DEFINITIONS QT_QUICKCONTROLS2_LIB)
    set(_Qt5QuickTemplates2_MODULE_DEPENDENCIES "Quick;Gui;Core")


    set(Qt5QuickTemplates2_OWN_PRIVATE_INCLUDE_DIRS )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.0 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
